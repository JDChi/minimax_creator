        ...
        <div className="animate-fade-in opacity-0" style={{ animationFillMode: 'forwards' }}>
          <div className="relative group">
            <div className={`absolute -inset-0.5 rounded-2xl blur opacity-20 group-hover:opacity-40 transition duration-500 ${
              activeTab === 'image' ? 'bg-gradient-to-r from-indigo-500 to-purple-500' :
              activeTab === 'video' ? 'bg-gradient-to-r from-purple-500 to-pink-500' :
              activeTab === 'music' ? 'bg-gradient-to-r from-pink-500 to-amber-500' :
